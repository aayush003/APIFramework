...
public class StepDefinition extends Utils {
	...
	public void user_calls_with_post_http_request(String resource, String method) {
		...
		response_specification = new ResponseSpecBuilder().expectStatusCode(200).expectContentType(ContentType.JSON).build();
	...
	public void in_response_body_is(String key, String expected_value) {
		...
		assertEquals(getJsonPath(response, key), expected_value);
	}
